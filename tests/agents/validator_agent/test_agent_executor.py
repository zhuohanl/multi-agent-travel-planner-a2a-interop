"""Unit tests for Validator Agent agent_executor.py."""
...
class TestAgentFrameworkValidatorAgentExecutor:
    """Tests for AgentFrameworkValidatorAgentExecutor class."""
    ...
    def executor_class(self, mock_environment):
        ...
        with patch.dict(os.environ, mock_environment):
            ...
            yield AgentFrameworkValidatorAgentExecutor

    def test_build_agent_returns_validator_agent(self, executor_class, mock_environment):
        """Test that build_agent returns an AgentFrameworkValidatorAgent instance."""
        with patch.dict(os.environ, mock_environment):
            ...
            assert isinstance(agent, AgentFrameworkValidatorAgent)
    ...
    def test_executor_inherits_from_base(self, mock_environment):
        ...
        with patch.dict(os.environ, mock_environment):
            ...
            assert issubclass(AgentFrameworkValidatorAgentExecutor, BaseA2AAgentExecutor)
