...
```bash
# Navigate to weather_proxy_m365_agent_sdk_interactive_flow directory
cd interoperability/foundry/agents/weather/weather_proxy_m365_agent_sdk_interactive_flow
...
4. Run the CopilotStudioClient sample using
