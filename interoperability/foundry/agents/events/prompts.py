"""
Prompts module for Events Agent.

This module provides access to the Events agent's system prompt
by using the extract_agent module to load from the canonical source.

The prompt content comes from src/prompts/events.txt and is
...
def get_system_prompt() -> str:
    """Get the Events agent's system prompt.

    Extracts the prompt from src/prompts/events.txt via the
    ...
    """
    return extract_system_prompt("src/agents/events_agent")
